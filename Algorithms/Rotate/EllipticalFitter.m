classdef EllipticalFitter < ConicFitter
    ...
    methods
        function obj=EllipticalFitter(XY)
            ...
            XY0 = XY;
            [XY, T]=ConicFitter.homogNorm(XY0);
        ...
        function hFit=fimplicit(obj,varargin)
            varargin=ConicFitter.lineDefaults(varargin);
    ...
    methods (Static)
        ...
        function xy = xysim(center,ab,theta,t,sig)
            % xy = EllipticalFitter.xysim(center,radii,angle,azimSamps,sig)
            %
            %IN:
            %
