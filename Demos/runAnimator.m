...
scalebar = AxisScalebar(animator.getAxis(), ...
...
set(scalebar.getHorizontalText(), ...
    "FontSize", 12, ...
    "FontWeight", "normal", ...
    "FontName", "Arial", ...
    "Color", "black", ...
...
set(scalebar.getHorizontalLine(), ...
    "Color", "black", ...
    "LineStyle", "-", ...
    "LineWidth", 5, ...
    "Marker", "none", ...
