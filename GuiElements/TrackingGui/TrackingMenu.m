...
generateOpenRotatorMenu(m, trackingLinker);
generateProbeCalibratorMenu(m, trackingLinker);
roiMenu = generateOpenRoiMenu(m, trackingLinker);
generateOpenWaterfallMenu(m, trackingLinker);

set(roiMenu, "Separator", "on");
end
function generateOpenDetrenderMenu(parentMenu, trackingLinker)
uimenu(parentMenu, ...
    "Text", "Detrend Results", ...
    "MenuSelectedFcn", @trackingLinker.openDetrenderButtonPushed ...
    );
end
function generateOpenRotatorMenu(parentMenu, trackingLinker)
uimenu(parentMenu, ...
    "Text", "Rotate Results", ...
    "MenuSelectedFcn", @trackingLinker.openRotatorButtonPushed ...
    );
end
...
function m = generateOpenRoiMenu(parentMenu, trackingLinker)
m = uimenu(parentMenu, ...
    "Text", "Open ROI Plot", ...
